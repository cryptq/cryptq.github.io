...
static bool bEnableReporting = true;
static bool          tlm_enable_info_reporting = bEnableReporting;     ///< info level reporting enable
static bool          tlm_enable_warning_reporting = bEnableReporting;  ///< warning level reporting enable
static bool          tlm_enable_error_reporting = bEnableReporting;    ///< error level reporting enable
static bool          tlm_enable_fatal_reporting = bEnableReporting;    ///< fatal level reporting enable

static ostringstream reporting_os;                  ///< reporting output string
