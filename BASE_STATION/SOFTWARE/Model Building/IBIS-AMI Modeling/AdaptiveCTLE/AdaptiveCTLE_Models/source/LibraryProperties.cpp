// Uncomment the line "LibraryProperties->SetLibraryName(...)" and replace "AdaptiveCTLE" with desired SystemVue model library name.
...
// 	pLibraryProperties->SetLibraryName( "AdaptiveCTLE" );
