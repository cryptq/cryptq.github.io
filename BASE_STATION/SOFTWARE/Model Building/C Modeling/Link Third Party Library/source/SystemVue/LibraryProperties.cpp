// Uncomment the line "LibraryProperties->SetLibraryName(...)" and replace "RemezLPF" with desired SystemVue model library name.
...
{	
	...
	// By default, the DLL name is used.
 	pLibraryProperties->SetLibraryName( "LinkThirdPartyLibExample" );
