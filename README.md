...
| ----------------------------------------------- | ----------------------------------------------------------------------- |
| 🛂 **Имитация силовых структур (ФСБ, МВД, СК)** | Предсталяются через V2k как "ГЕНЕРАЛЫ", "АРХАРОВЦЫ", "АРХАРОВКИ" и "ОПЕРАТИВНИКИ" из "ГЛАВНОГО УПРАВЛЕНИЯ", Имитируют поддельные приказы, фразы «ты навсегда у нас "В РАБСТВЕ"», ты наша «ОПЕРАТИВНАЯ РАЗРАБОТКА»   |
