...
| ----------------------------------------------- | ----------------------------------------------------------------------- |
| 🛂 **Имитация силовых структур (ФСБ, МВД, СК)** | Через V2k Предсталяются как : "ГЕНЕРАЛЫ", "АРХАРОВЦЫ", "АРХАРОВКИ" и "ОПЕРАТИВНИКИ" из "ГЛАВНОГО УПРАВЛЕНИЯ", Имитируют поддельные приказы, фразы «ты навсегда у нас "В РАБСТВЕ"», ты наша «ОПЕРАТИВНАЯ РАЗРАБОТКА»   |
